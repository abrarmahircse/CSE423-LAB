...
# ===== Display callback =====
def display():
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT)  # Clear screen and depth buffer (2d,3d) rendse
...
def main():
    ...
    glutCreateWindow(b"OpenGL 2D Point")     # Create window with a title basically name 
    glutDisplayFunc(display)                 # Register display callback
    glutMainLoop()                           # Start the main event-processing loop infnitelt running 
